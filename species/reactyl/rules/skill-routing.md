...
## 6. Harness Maintenance, Evolution, or Auditing

- **Mandatory Skill**: `.agents/skills/harness-evolution/SKILL.md`
- **When**: User asks to audit harness, add rules, improve workflows, or optimize prompt tokens.
- **Directives**:
